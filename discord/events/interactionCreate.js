    ...
    async run(bot, interaction) {
        ...
        switch (interaction.type) {
            ...
            case InteractionType.ApplicationCommand: 
                ...
                if (command.channels_blacklist && command.channels_blacklist?.includes(interaction.channel.id)) return interaction.reply({ embeds: [errorEmbed(`Cette commande n'est pas utilisable dans ce salon`)], ephemeral: true });
